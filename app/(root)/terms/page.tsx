...
const page = () => {
  return (
    <main className="mx-auto max-w-4xl px-6 py-10 space-y-8">
      <header>
        <h1 className="text-3xl font-semibold text-white">Terms & Disclaimers</h1>
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        <h2 className="text-xl font-semibold text-white">2. No Medical Advice</h2>
        <p className="mt-2 text-slate-300 text-sm leading-6">
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        <h2 className="text-xl font-semibold text-white">6. Accuracy & Liability</h2>
        <p className="mt-2 text-slate-300 text-sm leading-6">
